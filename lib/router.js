...
Router.route('adminTools', {
  path: AdminDashboard.path('adminTools'),
  controller: 'AdminController',
  onAfterAction: function () {
    Session.set('admin_title', 'Admin Tools');
  }
});
...
Router.plugin('ensureSignedIn', {
   only: ['adminToold', 'socialPostsListNew', 'socialPostsListApproved', 'socialPostsListDeleted', 'socialPostsListWeb', 'socialPostsListIonic', 'new', 'apporved', 'deleted', 'profile']
});
